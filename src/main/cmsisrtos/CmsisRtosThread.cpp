...
/* ****************************************************************************************
 * Public Method <Override> - mcuf::lang::rtos::InterfaceThread
 */
 ...
 */
mcuf::lang::ThreadState CmsisRtosThread::threadGetState(const mcuf::lang::Memory& handler) const{
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
  
  switch(osThreadGetState(h->id)){
    case osThreadInactive:
      return mcuf::lang::ThreadState::INACTIVE;
    
    case osThreadReady:
      return mcuf::lang::ThreadState::READY;
    
    case osThreadRunning:
      return mcuf::lang::ThreadState::RUNNING;
    
    case osThreadBlocked:
      return mcuf::lang::ThreadState::BLOCKED;
    
    case osThreadTerminated:
      return mcuf::lang::ThreadState::TERMINATED;
    
    case osThreadError:
      return mcuf::lang::ThreadState::ERROR;
 ...
 * @param name 
 */
void CmsisRtosThread::threadSetName(mcuf::lang::Memory& handler, const char* name){
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
  h->handler.name = name;
  return;
}
 ...
 * @return uint32_t 
 */
uint32_t CmsisRtosThread::threadGetID(const mcuf::lang::Memory& handler) const{
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
 ...
 * @return const char* 
 */
const char* CmsisRtosThread::threadGetName(const mcuf::lang::Memory& handler) const{
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
 ...
 */
mcuf::lang::ThreadPriority CmsisRtosThread::threadGetPriority(const mcuf::lang::Memory& handler) const{
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
  return static_cast<mcuf::lang::ThreadPriority>(osThreadGetPriority(h->id));
}
/**
 * @brief 
 * 
 ...
 * @return false 
 */
bool CmsisRtosThread::threatStart(mcuf::lang::Memory& handler, mcuf::lang::ThreadPriority priority, mcuf::lang::Memory& stackMemory, mcuf::function::Runnable& runnable){
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
 ...
 * @return mcuf::lang::ThreadPriority 
 */
bool CmsisRtosThread::threadSetPriority(mcuf::lang::Memory& handler, mcuf::lang::ThreadPriority priority) const{
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
 ...
 * @return false 
 */
bool CmsisRtosThread::threadExit(mcuf::lang::Memory& handler){
  osThreadExit();
}
 ...
 * @return int 
 */
int CmsisRtosThread::threadGetStackSize(const mcuf::lang::Memory& handler) const{
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
 ...
 * @return false 
 */
bool CmsisRtosThread::threadNotify(const mcuf::lang::Memory& handler) const{
  cmsis_rtos_thread_memory_t* h  = static_cast<cmsis_rtos_thread_memory_t*>(handler.pointer());
